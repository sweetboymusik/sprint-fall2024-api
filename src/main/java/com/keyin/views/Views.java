package com.keyin.views;

public class Views {
    public static class CityView {}   // For cities with airports but without `city` inside `Airport`
    public static class AirportView {}  // For airports with full `city` details
